    ...
    C: Composer,
{
    ...
    let mut container = [C::ZERO; WIDTH];
    ...
    (0..DEPTH).fold(leaf, |root, depth| {
        ...
        let mut sum = C::ZERO;
        let mut offset_bits = [C::ZERO; WIDTH - 1];
...
mod tests {
    ...
    use crate::tree::{self, ArionLeaf, ArionTree};
